...
<a href="excel_action.php?search=<?php if(isset($search_value)){ echo $search_value;} ?>" class="btn btn-outline-info float-right">Download excel</a>

<a href="pdf_action.php?search=<?php  if(isset($search_value)){ echo $search_value;} ?>" class="btn btn-outline-info float-right">Download pdf</a>
