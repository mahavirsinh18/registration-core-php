...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if($isValid == true){
		$sql = "UPDATE registration SET name='$name', email='$email', password='$password', contact='$contact', city='$city', gender='$gender', pro_image='$pro_image' WHERE id = $id";
...
<div class="container">
	<form action="update.php?id=<?php echo $OldValue['id']; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
